/* @flow */
import kidsagree from './kidsagree.json'

type GroupName = 'theme' | 'themeDark' | 'brand' | 'colors'

// These need to match the names in the Open Color palettes
const THEME_NAME = 'Kidsagree UI'
const THEME_DARK_NAME = 'Kidsagree UI Dark'
const BRAND_NAME = 'Kidsagree Brand'
...
const { themeDark, theme, brand, colors } = groups(kidsagree)
